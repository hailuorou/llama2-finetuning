...
from quantization.awq.quantize.pre_quant import apply_awq
from quantization.awq.quantize.quantizer import pseudo_quantize_model_weight
...
#local model
model_name = "/zeng_chao/dataset/llmWeight/llama-2-7b-chat-hf"
...
# 进行llama2 weight伪量化
awq_results = torch.load("/zeng_chao/code/llm-awq/data/llama-2-7b-chat-hf-o-w4-g128.pt", map_location="cpu")
...
per_device_train_batch_size = 1 # 对于每个设备（例如每块GPU），在训练期间每次迭代使用的样本数量。
